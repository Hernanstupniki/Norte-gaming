import { ProductsManageClient } from "@/components/admin/products-manage-client";
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <section className="rounded-xl sm:rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5 md:p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-2xl sm:text-3xl font-black tracking-tight text-zinc-950">Gestión de productos</h1>
        <p className="mt-2 text-xs sm:text-sm text-zinc-600 md:text-base">
          Buscá, editá y controlá stock desde un solo listado.
        </p>
      </section>
      <ProductsManageClient />
    </div>
  );
}
